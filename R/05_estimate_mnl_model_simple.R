...
#
# Purpose:
#   Estimates the simpler multinomial logit (MNL) model for the choice
#   experiment, without treatment interaction terms.
#
# Input:
...
#   defines a standard MNL utility specification, estimates the model using
#   Apollo, and saves the estimation output. 
# ------------------------------------------------------------------------------
...
# Apollo controls --------------------------------------------------------------
apollo_control <- list(
  modelName = "MNL_simple_model",
  modelDescr = "Simple multinomial logit model of minced meat choices",
  indivID = "respid",
...
apollo_probabilities <- function(apollo_beta, apollo_inputs, functionality = "estimate") {
  ...
  # Utility functions
  V <- list(
    beef = asc_beef + b_price * price_beef,
    fifty = asc_fifty + b_price * price_fifty,
    vegan = asc_vegan + b_price * price_vegan,
    chicken = asc_chicken + b_price * price_chicken,
    pork = asc_pork + b_price * price_pork,
