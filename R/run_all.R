...
source(file.path("R", "08_estimate_lc_model_simple.R"))
source(file.path("R", "09_compute_lc_postestimation_wtp.R"))
source(file.path("R", "10_figure_6.R"))
source(file.path("R", "11_figure_7.R"))
source(file.path("R", "12_figure_8.R"))
source(file.path("R", "13_table_A1.R"))
source(file.path("R", "14_table_A2.R"))
1
